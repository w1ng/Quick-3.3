...
int lua_gaf_GAFAsset_getCustomRegion(lua_State* tolua_S)
{
    int argc = 0;
    gaf::GAFAsset* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_gaf_GAFAsset_getCustomRegion'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_std_string(tolua_S, 2,&arg0, "gaf.GAFAsset:getCustomRegion");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_gaf_GAFAsset_getCustomRegion'", nullptr);
            return 0;
        }
        gaf::GAFSprite* ret = cobj->getCustomRegion(arg0);
        object_to_luaval<gaf::GAFSprite>(tolua_S, "gaf.GAFSprite",(gaf::GAFSprite*)ret);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "gaf.GAFAsset:getCustomRegion",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_gaf_GAFAsset_getCustomRegion'.",&tolua_err);
#endif
...
int lua_gaf_GAFAsset_setSceneColor(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        ...
        ok &=luaval_to_color4b(tolua_S, 2, &arg0, "gaf.GAFAsset:setSceneColor");
        if(!ok)
        {
...
int lua_gaf_GAFAsset_loadImages(lua_State* tolua_S)
{
    int argc = 0;
    gaf::GAFAsset* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_gaf_GAFAsset_loadImages'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_number(tolua_S, 2,&arg0, "gaf.GAFAsset:loadImages");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_gaf_GAFAsset_loadImages'", nullptr);
            return 0;
        }
        cobj->loadImages(arg0);
        return 0;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "gaf.GAFAsset:loadImages",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_gaf_GAFAsset_loadImages'.",&tolua_err);
#endif
...
int lua_gaf_GAFAsset_createObjectAndRun(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_boolean(tolua_S, 2,&arg0, "gaf.GAFAsset:createObjectAndRun");
        if(!ok)
        {
...
int lua_gaf_GAFAsset_setDesiredAtlasScale(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_number(tolua_S, 2,&arg0, "gaf.GAFAsset:setDesiredAtlasScale");
        if(!ok)
        {
...
int lua_gaf_GAFAsset_soundEvent(lua_State* tolua_S)
{
    int argc = 0;
    gaf::GAFAsset* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_gaf_GAFAsset_soundEvent'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_object<gaf::GAFTimelineAction>(tolua_S, 2, "gaf.GAFTimelineAction",&arg0);
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_gaf_GAFAsset_soundEvent'", nullptr);
            return 0;
        }
        cobj->soundEvent(arg0);
        return 0;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "gaf.GAFAsset:soundEvent",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_gaf_GAFAsset_soundEvent'.",&tolua_err);
#endif
...
int lua_gaf_GAFAsset_setSoundDelegate(lua_State* tolua_S)
{
    int argc = 0;
    gaf::GAFAsset* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_gaf_GAFAsset_setSoundDelegate'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        std::function<void (gaf::GAFSoundInfo *, int, gaf::GAFSoundInfo::SyncEvent)> arg0;
        ...
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_gaf_GAFAsset_setSoundDelegate'", nullptr);
            return 0;
        }
        cobj->setSoundDelegate(arg0);
        return 0;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "gaf.GAFAsset:setSoundDelegate",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_gaf_GAFAsset_setSoundDelegate'.",&tolua_err);
#endif
...
int lua_gaf_GAFAsset_initWithGAFBundle(lua_State* tolua_S)
{
    ...
    if (argc == 3) 
    {
        ...
        ok &= luaval_to_std_string(tolua_S, 2,&arg0, "gaf.GAFAsset:initWithGAFBundle");

        ok &= luaval_to_std_string(tolua_S, 3,&arg1, "gaf.GAFAsset:initWithGAFBundle");
    ...
    if (argc == 4) 
    {
        ...
        ok &= luaval_to_object<gaf::GAFLoader>(tolua_S, 5, "gaf.GAFLoader",&arg3);
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_gaf_GAFAsset_initWithGAFBundle'", nullptr);
            return 0;
        }
        bool ret = cobj->initWithGAFBundle(arg0, arg1, arg2, arg3);
        tolua_pushboolean(tolua_S,(bool)ret);
        return 1;
    }
...
int lua_gaf_GAFAsset_setSceneHeight(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_uint32(tolua_S, 2,&arg0, "gaf.GAFAsset:setSceneHeight");
        if(!ok)
        {
...
int lua_gaf_GAFAsset_setSceneWidth(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_uint32(tolua_S, 2,&arg0, "gaf.GAFAsset:setSceneWidth");
        if(!ok)
        {
...
int lua_gaf_GAFAsset_initWithGAFFile(lua_State* tolua_S)
{
    ...
    if (argc == 2) 
    {
        ...
        ok &= luaval_to_std_string(tolua_S, 2,&arg0, "gaf.GAFAsset:initWithGAFFile");
    ...
    if (argc == 3) 
    {
        ...
        ok &= luaval_to_object<gaf::GAFLoader>(tolua_S, 4, "gaf.GAFLoader",&arg2);
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_gaf_GAFAsset_initWithGAFFile'", nullptr);
            return 0;
        }
        bool ret = cobj->initWithGAFFile(arg0, arg1, arg2);
        tolua_pushboolean(tolua_S,(bool)ret);
        return 1;
    }
...
int lua_gaf_GAFAsset_setSceneFps(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_uint32(tolua_S, 2,&arg0, "gaf.GAFAsset:setSceneFps");
        if(!ok)
        {
...
int lua_gaf_GAFAsset_getTextureAtlas(lua_State* tolua_S)
{
    int argc = 0;
    gaf::GAFAsset* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_gaf_GAFAsset_getTextureAtlas'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_gaf_GAFAsset_getTextureAtlas'", nullptr);
            return 0;
        }
        gaf::GAFTextureAtlas* ret = cobj->getTextureAtlas();
        object_to_luaval<gaf::GAFTextureAtlas>(tolua_S, "gaf.GAFTextureAtlas",(gaf::GAFTextureAtlas*)ret);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "gaf.GAFAsset:getTextureAtlas",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_gaf_GAFAsset_getTextureAtlas'.",&tolua_err);
#endif
...
int lua_gaf_GAFAsset_getTimelineByName(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_std_string(tolua_S, 2,&arg0, "gaf.GAFAsset:getTimelineByName");
        if(!ok)
        {
...
int lua_gaf_GAFAsset_isAssetVersionPlayable(lua_State* tolua_S)
{
    ...
    {
        const char* arg0;
        std::string arg0_tmp; ok &= luaval_to_std_string(tolua_S, 2, &arg0_tmp, "gaf.GAFAsset:isAssetVersionPlayable"); arg0 = arg0_tmp.c_str();
        if(!ok)
        {
...
int lua_gaf_GAFAsset_create(lua_State* tolua_S)
{
    ...
    do 
    {
        ...
        {
            std::string arg0;
            ok &= luaval_to_std_string(tolua_S, 2,&arg0, "gaf.GAFAsset:create");
            if (!ok) { break; }
    ...
    do 
    {
		...
		;
            ...
            ok &= luaval_to_object<gaf::GAFLoader>(tolua_S, 4, "gaf.GAFLoader",&arg2);
            if (!ok) { break; }
            gaf::GAFAsset* ret = gaf::GAFAsset::create(arg0, arg1, arg2);
            object_to_luaval<gaf::GAFAsset>(tolua_S, "gaf.GAFAsset",(gaf::GAFAsset*)ret);
            return 1;
        }
    } while (0);
...
int lua_gaf_GAFAsset_createWithBundle(lua_State* tolua_S)
{
    ...
    do 
    {
        ...
        {
            std::string arg0;
            ok &= luaval_to_std_string(tolua_S, 2,&arg0, "gaf.GAFAsset:createWithBundle");
            if (!ok) { break; }
            std::string arg1;
            ok &= luaval_to_std_string(tolua_S, 3,&arg1, "gaf.GAFAsset:createWithBundle");
            if (!ok) { break; }
            gaf::GAFAsset* ret = gaf::GAFAsset::createWithBundle(arg0, arg1);
            object_to_luaval<gaf::GAFAsset>(tolua_S, "gaf.GAFAsset",(gaf::GAFAsset*)ret);
            return 1;
        }
    } while (0);
    ...
    do 
    {
		...
		;
            ...
            ok &= luaval_to_object<gaf::GAFLoader>(tolua_S, 5, "gaf.GAFLoader",&arg3);
            if (!ok) { break; }
            gaf::GAFAsset* ret = gaf::GAFAsset::createWithBundle(arg0, arg1, arg2, arg3);
            object_to_luaval<gaf::GAFAsset>(tolua_S, "gaf.GAFAsset",(gaf::GAFAsset*)ret);
            return 1;
        }
    } while (0);
    ok  = true;
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d", "gaf.GAFAsset:createWithBundle",argc, 3);
    return 0;
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
...
int lua_register_gaf_GAFAsset(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"GAFAsset");
        ...
        tolua_function(tolua_S,"getCustomRegion",lua_gaf_GAFAsset_getCustomRegion);
        ...
        tolua_function(tolua_S,"loadImages",lua_gaf_GAFAsset_loadImages);
        ...
        tolua_function(tolua_S,"soundEvent",lua_gaf_GAFAsset_soundEvent);
        tolua_function(tolua_S,"getRootTimeline",lua_gaf_GAFAsset_getRootTimeline);
        tolua_function(tolua_S,"setSoundDelegate",lua_gaf_GAFAsset_setSoundDelegate);
        ...
        tolua_function(tolua_S,"getTextureAtlas",lua_gaf_GAFAsset_getTextureAtlas);
...
int lua_gaf_GAFSprite_setLocator(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_boolean(tolua_S, 2,&arg0, "gaf.GAFSprite:setLocator");
        if(!ok)
        {
...
int lua_gaf_GAFObject_setFps(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_uint32(tolua_S, 2,&arg0, "gaf.GAFObject:setFps");
        if(!ok)
        {
...
int lua_gaf_GAFObject_getObjectByName(lua_State* tolua_S)
{
    ...
    do{
        if (argc == 1) {
            std::string arg0;
            ok &= luaval_to_std_string(tolua_S, 2,&arg0, "gaf.GAFObject:getObjectByName");
...
int lua_gaf_GAFObject_gotoAndStop(lua_State* tolua_S)
{
    ...
    do{
        if (argc == 1) {
            unsigned int arg0;
            ok &= luaval_to_uint32(tolua_S, 2,&arg0, "gaf.GAFObject:gotoAndStop");
    ...
    do{
        if (argc == 1) {
            std::string arg0;
            ok &= luaval_to_std_string(tolua_S, 2,&arg0, "gaf.GAFObject:gotoAndStop");
...
int lua_gaf_GAFObject_getStartFrame(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_std_string(tolua_S, 2,&arg0, "gaf.GAFObject:getStartFrame");
        if(!ok)
        {
...
int lua_gaf_GAFObject_playSequence(lua_State* tolua_S)
{
    ...
    if (argc == 2) 
    {
        ...
        ok &= luaval_to_std_string(tolua_S, 2,&arg0, "gaf.GAFObject:playSequence");

        ok &= luaval_to_boolean(tolua_S, 3,&arg1, "gaf.GAFObject:playSequence");
        if(!ok)
        {
    ...
    if (argc == 3) 
    {
        ...
        ok &= luaval_to_boolean(tolua_S, 4,&arg2, "gaf.GAFObject:playSequence");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_gaf_GAFObject_playSequence'", nullptr);
            return 0;
...
int lua_gaf_GAFObject_enableTick(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_boolean(tolua_S, 2,&arg0, "gaf.GAFObject:enableTick");
        if(!ok)
        {
...
int lua_gaf_GAFObject_setAnimationRunning(lua_State* tolua_S)
{
    ...
    if (argc == 2) 
    {
        ...
        ok &= luaval_to_boolean(tolua_S, 2,&arg0, "gaf.GAFObject:setAnimationRunning");

        ok &= luaval_to_boolean(tolua_S, 3,&arg1, "gaf.GAFObject:setAnimationRunning");
        if(!ok)
        {
...
int lua_gaf_GAFObject_setFrame(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_uint32(tolua_S, 2,&arg0, "gaf.GAFObject:setFrame");
        if(!ok)
        {
...
int lua_gaf_GAFObject_setLooped(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_boolean(tolua_S, 2,&arg0, "gaf.GAFObject:setLooped");
        if(!ok)
        {
    ...
    if (argc == 2) 
    {
        ...
        ok &= luaval_to_boolean(tolua_S, 3,&arg1, "gaf.GAFObject:setLooped");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_gaf_GAFObject_setLooped'", nullptr);
            return 0;
...
int lua_gaf_GAFObject_getEndFrame(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_std_string(tolua_S, 2,&arg0, "gaf.GAFObject:getEndFrame");
        if(!ok)
        {
...
int lua_gaf_GAFObject_gotoAndPlay(lua_State* tolua_S)
{
    ...
    do{
        if (argc == 1) {
            unsigned int arg0;
            ok &= luaval_to_uint32(tolua_S, 2,&arg0, "gaf.GAFObject:gotoAndPlay");
    ...
    do{
        if (argc == 1) {
            std::string arg0;
            ok &= luaval_to_std_string(tolua_S, 2,&arg0, "gaf.GAFObject:gotoAndPlay");
...
int lua_gaf_GAFObject_setReversed(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_boolean(tolua_S, 2,&arg0, "gaf.GAFObject:setReversed");
        if(!ok)
        {
    ...
    if (argc == 2) 
    {
        ...
        ok &= luaval_to_boolean(tolua_S, 3,&arg1, "gaf.GAFObject:setReversed");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_gaf_GAFObject_setReversed'", nullptr);
            return 0;
...
int lua_gaf_GAFObject_setFpsLimitations(lua_State* tolua_S)
{
    int argc = 0;
    gaf::GAFObject* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_gaf_GAFObject_setFpsLimitations'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_boolean(tolua_S, 2,&arg0, "gaf.GAFObject:setFpsLimitations");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_gaf_GAFObject_setFpsLimitations'", nullptr);
            return 0;
        }
        cobj->setFpsLimitations(arg0);
        return 0;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "gaf.GAFObject:setFpsLimitations",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_gaf_GAFObject_setFpsLimitations'.",&tolua_err);
#endif
...
int lua_gaf_GAFObject_getTimeLine(lua_State* tolua_S)
{
    int argc = 0;
    gaf::GAFObject* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_gaf_GAFObject_getTimeLine'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_gaf_GAFObject_getTimeLine'", nullptr);
            return 0;
        }
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "gaf.GAFObject:getTimeLine",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_gaf_GAFObject_getTimeLine'.",&tolua_err);
#endif
...
int lua_register_gaf_GAFObject(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"GAFObject");
        ...
        tolua_function(tolua_S,"setFpsLimitations",lua_gaf_GAFObject_setFpsLimitations);
        tolua_function(tolua_S,"hasSequences",lua_gaf_GAFObject_hasSequences);
        tolua_function(tolua_S,"getFps",lua_gaf_GAFObject_getFps);
        tolua_function(tolua_S,"getTimeLine",lua_gaf_GAFObject_getTimeLine);
...
int lua_gaf_GAFAssetTextureManager_swapTexture(lua_State* tolua_S)
{
    int argc = 0;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_gaf_GAFAssetTextureManager_swapTexture'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 2) 
    {
        ...
        ok &= luaval_to_uint32(tolua_S, 2,&arg0, "gaf.GAFAssetTextureManager:swapTexture");

        ok &= luaval_to_object<cocos2d::Texture2D>(tolua_S, 3, "cc.Texture2D",&arg1);
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_gaf_GAFAssetTextureManager_swapTexture'", nullptr);
            return 0;
        }
        bool ret = cobj->swapTexture(arg0, arg1);
        tolua_pushboolean(tolua_S,(bool)ret);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "gaf.GAFAssetTextureManager:swapTexture",argc, 2);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_gaf_GAFAssetTextureManager_swapTexture'.",&tolua_err);
#endif
...
int lua_register_gaf_GAFAssetTextureManager(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"GAFAssetTextureManager");
        ...
        tolua_function(tolua_S,"swapTexture",lua_gaf_GAFAssetTextureManager_swapTexture);
...
int lua_gaf_GAFMovieClip_setGLProgram(lua_State* tolua_S)
{
    int argc = 0;
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertype(tolua_S,1,"gaf.GAFMovieClip",0,&tolua_err)) goto tolua_lerror;
#endif

    cobj = (gaf::GAFMovieClip*)tolua_tousertype(tolua_S,1,0);

#if COCOS2D_DEBUG >= 1
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_gaf_GAFMovieClip_setGLProgram'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_gaf_GAFMovieClip_setGLProgram'", nullptr);
            return 0;
        }
        cobj->setGLProgram(arg0);
        return 0;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "gaf.GAFMovieClip:setGLProgram",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_gaf_GAFMovieClip_setGLProgram'.",&tolua_err);
#endif
...
int lua_register_gaf_GAFMovieClip(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"GAFMovieClip");
        ...
        tolua_function(tolua_S,"setGLProgram",lua_gaf_GAFMovieClip_setGLProgram);
    tolua_endmodule(tolua_S);
