...
--------------------------------
-- 
-- @function [parent=#GAFAsset] getCustomRegion 
-- @param self
-- @param #string name
-- @return GAFSprite#GAFSprite ret (return value: gaf.GAFSprite)
...
--------------------------------
-- 
-- @function [parent=#GAFAsset] loadImages 
-- @param self
-- @param #float desiredAtlasScale
...
--------------------------------
-- 
-- @function [parent=#GAFAsset] soundEvent 
-- @param self
-- @param #gaf.GAFTimelineAction action
...
--------------------------------
-- 
-- @function [parent=#GAFAsset] setSoundDelegate 
-- @param self
-- @param #function delagate
...
--------------------------------
-- 
-- @function [parent=#GAFAsset] getTextureAtlas 
-- @param self
-- @return GAFTextureAtlas#GAFTextureAtlas ret (return value: gaf.GAFTextureAtlas)
