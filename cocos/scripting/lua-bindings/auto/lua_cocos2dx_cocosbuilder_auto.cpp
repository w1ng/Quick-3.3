...
int lua_cocos2dx_cocosbuilder_CCBReader_getSubCCBFiles(lua_State* tolua_S)
{
    int argc = 0;
    cocosbuilder::CCBReader* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_cocosbuilder_CCBReader_getSubCCBFiles'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_cocosbuilder_CCBReader_getSubCCBFiles'", nullptr);
            return 0;
        }
        cocos2d::Vector<cocosbuilder::CCBReader *>& ret = cobj->getSubCCBFiles();
        ccvector_to_luaval(tolua_S, ret);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "cc.CCBReader:getSubCCBFiles",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_cocosbuilder_CCBReader_getSubCCBFiles'.",&tolua_err);
#endif
...
int lua_cocos2dx_cocosbuilder_CCBReader_addSubCCBFile(lua_State* tolua_S)
{
    int argc = 0;
    cocosbuilder::CCBReader* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_cocosbuilder_CCBReader_addSubCCBFile'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_cocosbuilder_CCBReader_addSubCCBFile'", nullptr);
            return 0;
        }
        cobj->addSubCCBFile(arg0);
        return 0;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "cc.CCBReader:addSubCCBFile",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_cocosbuilder_CCBReader_addSubCCBFile'.",&tolua_err);
#endif
...
int lua_cocos2dx_cocosbuilder_CCBReader_getDocumentControllerName(lua_State* tolua_S)
{
    int argc = 0;
    cocosbuilder::CCBReader* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_cocosbuilder_CCBReader_getDocumentControllerName'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_cocosbuilder_CCBReader_getDocumentControllerName'", nullptr);
            return 0;
        }
        std::string ret = cobj->getDocumentControllerName();
        tolua_pushcppstring(tolua_S,ret);
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "cc.CCBReader:getDocumentControllerName",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_cocosbuilder_CCBReader_getDocumentControllerName'.",&tolua_err);
#endif
...
int lua_register_cocos2dx_cocosbuilder_CCBReader(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"CCBReader");
        ...
        tolua_function(tolua_S,"getSubCCBFiles",lua_cocos2dx_cocosbuilder_CCBReader_getSubCCBFiles);
        ...
        tolua_function(tolua_S,"addSubCCBFile",lua_cocos2dx_cocosbuilder_CCBReader_addSubCCBFile);
        ...
        tolua_function(tolua_S,"getDocumentControllerName",lua_cocos2dx_cocosbuilder_CCBReader_getDocumentControllerName);
